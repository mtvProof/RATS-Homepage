...
const sortingButtonsPage4 = [
  ...
  },
  {
    ...
    "IsBlueprint": false,
    "BufferTransferRemaining": 0,
    "TargetItemName": "industrial.combiner"
  },
  {
    "TargetCategory": null,
    "MaxAmountInOutput": 0,
    ...
    "IsBlueprint": false,
    "BufferTransferRemaining": 0,
    "TargetItemName": "industrial.splitter"
  },
  {
    "TargetCategory": null,
    "MaxAmountInOutput": 0,
    ...
    "IsBlueprint": false,
    "BufferTransferRemaining": 0,
    "TargetItemName": "industrial.conveyor"
  },
  {
    "TargetCategory": null,
    "MaxAmountInOutput": 0,
  ...
  },
  {
    ...
    "IsBlueprint": false,
    "BufferTransferRemaining": 0,
    "TargetItemName": "computerstation"
  },
  {
    "TargetCategory": null,
    "MaxAmountInOutput": 0,
  ...
  },
  {
    ...
    "IsBlueprint": false,
    "BufferTransferRemaining": 0,
    "TargetItemName": "small.oil.refinery"
  }
]`
  },
  {
  ...
  {
    label: "Sheet Metal / Roadsigns / Fuzes",
    image: "roadsigns.png",
    message: `[
  {
    "TargetCategory": null,
  ...
  },
  {
    ...
    "IsBlueprint": false,
    "BufferTransferRemaining": 0,
    "TargetItemName": "burlap.headwrap"
  },
  {
    "TargetCategory": null,
    "MaxAmountInOutput": 0,
  ...
  },
  {
    ...
    "IsBlueprint": false,
    "BufferTransferRemaining": 0,
    "TargetItemName": "advancedblueprintfragment"
  },
  {
    "TargetCategory": null,
    "MaxAmountInOutput": 0,
    ...
    "IsBlueprint": false,
    "BufferTransferRemaining": 0,
    "TargetItemName": "basicblueprintfragment"
  }
]`
  }
];
...
function calculateToolCupboardAllocate() {
  ...
  const stackMult = parseFloat(document.getElementById('tcStackMult').value) || 1;
  
  // Stack sizes adjusted by multiplier
  const rates = [
    { key: 'wood', rate: wood, cap: 1000 * stackMult, label: 'Wood' },
    { key: 'stones', rate: stone, cap: 1000 * stackMult, label: 'Stone' },
    { key: 'metal.fragments', rate: frags, cap: 1000 * stackMult, label: 'Metal Fragments' },
    { key: 'metal.refined', rate: hqm, cap: 100 * stackMult, label: 'High Quality Metal' }
  ];
  const SLOT_LIMIT = 24;
  ...
  // binary search maximum runtime (days) such that required slots <= SLOT_LIMIT
  const maxTPerRes = rates.map(r => r.rate > 0 ? (r.cap * SLOT_LIMIT) / r.rate : 0);
  let high = Math.max(...maxTPerRes, 365); // max 1 year
  let low = 0;
  const eps = 1 / 86400; // precision in days (~1 second)
  while (high - low > eps) {
  ...
  const totalSeconds = Math.floor(T * 86400);
  const days = Math.floor(totalSeconds / 86400);
  const hours = Math.floor((totalSeconds % 86400) / 3600);
  const minutes = Math.floor((totalSeconds % 3600) / 60);
  const seconds = totalSeconds % 60;
  let runtime = '';
  if (days > 0) runtime += `${days} day${days === 1 ? '' : 's'}, `;
  runtime += `${hours} hour${hours === 1 ? '' : 's'}, ${minutes} minute${minutes === 1 ? '' : 's'}, ${seconds} second${seconds === 1 ? '' : 's'}`;
